(function () {
  ...
  var STATIC_REPOS = [
    {
      name: 'SVI_to_3d_code',
      description: 'Private — core SVI→3D reconstruction and novel pedestrian-view pipeline (patent in process).',
      html_url: 'https://github.com/X3n0xs/SVI_to_3d_code',
      language: 'Python'
    },
    {
      name: 'solar-exposure-analysis',
      description: 'Optional application note: solar / exposure metrics that can run on novel-view panoramas.',
